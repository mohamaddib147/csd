...
from interfaces_pb2 import msgX509CertReq_V2LTCA, msgTicketReq, msgPsnymCertReq_V2PCA, msgTicketRes,msgPsnymCertRes_PCA2V
...
class VPKIClient:
    ...
    def obtain_pseudonym(self, ticket):
        try:
            ...
            pseudonym_request.pstPsnymCertReq.extend([])
            ...
            try:
                ...
                print(f"Error obtaining pseudonym response: {e}")
